...
async function test() {
  ...
  const history = [
    { body: "Halo", aiReply: "Halo Kak! Ada yang bisa dibantu?" }
  ];
  ...
  parts.push('- Ini BUKAN pesan pertama (sudah ada riwayat chat): JANGAN ulangi penjelasan keunggulan produk yang sudah dijelaskan sebelumnya. Jawab LANGSUNG dan SINGKAT sesuai apa yang ditanya pelanggan saat ini saja, idealnya 1-2 kalimat');
  ...
  for (const h of history) {
    ...
    contents.push({ role: 'model', parts: [{ text: h.aiReply }] });
  }
